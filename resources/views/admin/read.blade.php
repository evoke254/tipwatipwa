...
<div class="content">
  <div class="container m-0 p-0" data-animation="true" data-animation-type="fadeInUp">
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-12">
          <a href="{{$moduleName}}/create" class="btn btn-sm btn-success"><i class=" ion-ios-add-circle-outline"></i> Create a {{$moduleName}}</a>
        </div>
              ...
              <table id="kahakidt" class="table table-striped table-hover">
                ...
                <tbody class="table-striped">
                  @foreach($contents as $content)
                    <tr>
                      <td> <img src="{{ asset('storage'.$content->image) }}" class="img-responsive img-fluid rounded" style="height: 75px"> </td>
