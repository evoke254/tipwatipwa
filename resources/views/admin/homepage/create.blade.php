    		...
    		<ul class="nav nav-tabs" id="myTab" role="tablist">
			  ...
			  <li class="nav-item">
			    <a class="nav-link" id="upload-tab" data-toggle="tab" href="#upload" role="tab" aria-controls="upload"
			      aria-selected="false">Homepage Photo Upload</a>
			  </li>
			  <li class="nav-item">
			  ...
			  <li class="nav-item">
			    <a class="nav-link" id="social-tab" data-toggle="tab" href="#social" role="tab" aria-controls="social"
			      aria-selected="false">Facebook & Google Pixels</a>
	   				...
	   				@if(\Request::is('*edit'))
						<form method="post" action="/admin/homepage/{{$homepage_content->id}}" enctype="multipart/form-data">
	   					@method('patch')
	   				@else
					...
					<div class="tab-content" id="myTabContent">
					  ...
					  <div class="tab-pane fade mt-3 pt-3" id="seo" role="tabpanel" aria-labelledby="seo-tab">
						    ...
						    <input type="text" class="form-control" id="page_title" name="page_title" aria-describedby="Page titke" placeholder="What describes your page best" value="{{$homepage_content->page_title ?? ''}}">
						  </div>
						  <div class="form-group">
