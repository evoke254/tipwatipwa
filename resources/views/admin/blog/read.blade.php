...
<div class="content">
  <div class="container m-0 p-0" data-animation="true" data-animation-type="fadeInUp">
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-12">
          <a href="{{$moduleName}}/create" class="btn btn-sm btn-success"><i class=" ion-ios-add-circle-outline"></i> Create a {{$moduleName}} post</a>
        </div>
              ...
              <table id="kahakidt" class="table table-striped table-hover">
                ...
                <tbody class="table-striped">
                  @foreach($contents as $content)
                    <tr>
                      <td width="75%">{{ substr($content->page, 0, 150) }}</td>
