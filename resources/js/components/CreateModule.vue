<template>
    <div class="content">
        ...
        <form method="POST" :action="'/admin/'+requestparams.moduleName" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div v-for="(field, type) in requestparams.fields" class="col-md-6">
                    ...
                    <div class="col">
                        <datetimepicker v-if="type.includes('date')" class="form-control border border-light" :name="field"></datetimepicker>
                         <textarea v-else-if="type.includes('text')" class=" col-md-12 form-control rounded-4 border border-light"  rows="5" :name="field" required=""></textarea>
                        <model-select 
                        ...
                        <div v-else-if="type.includes('file')" class="custom-file hoverable rounded">
                            <input type="file" class="custom-file-input" id="image"
                              aria-describedby="inputGroupFileAddon01" :name="field" required="">
